  ...
  return (
    <Card className="flex-1 flex flex-col h-full bg-card text-foreground">
      <Tabs defaultValue="orderbook" className="w-full flex-grow flex flex-col">
        ...
        <TabsContent value="orderbook" className={cn("flex-grow flex flex-col p-0 m-0 overflow-hidden", "data-[state=inactive]:hidden")}>
          ...
          <div className="py-1.5 px-3 text-center border-y border-border bg-card">
            {midPrice !== undefined ? (
              <span className="text-lg font-medium text-green-500 tabular-nums">{midPrice.toFixed(2)}</span>
            ) : (
          ...
          <div className="px-3 py-2 border-t border-border">
            <div className="h-3 bg-muted rounded-sm flex text-xs items-center relative">
              ...
              <div className="bg-destructive/80 h-full flex items-center justify-center text-white font-medium rounded-r-sm" style={{ width: `${askDepthPercentage}%` }}>
